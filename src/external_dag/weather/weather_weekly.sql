 ...
 * @param dataset_cdc_processed: CDC processed dataset - substitued using Jinja templating.
 */

-- TODO: Convert to incremental merge statement to avoid full refresh.
CREATE OR REPLACE TABLE {{ project_id_src }}.{{ dataset_cdc_processed }}.weather_weekly
AS
SELECT
  country,
  postcode,
