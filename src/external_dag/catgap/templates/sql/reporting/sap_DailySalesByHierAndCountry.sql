...
CREATE OR REPLACE VIEW `{{ project_id_tgt }}.{{ dataset_reporting_tgt }}.DailySalesByHierAndCountry` AS
(
...
FROM sales_orders
INNER JOIN `{{ project_id_src }}.{{ dataset_cdc_processed }}.prod_hierarchy` ph
