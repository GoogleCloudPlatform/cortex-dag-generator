...
CREATE OR REPLACE VIEW
  `{{ project_id_tgt }}.{{ dataset_reporting_tgt }}.WeeklySAPSalesAndAdsStatsByHierAndCountry`
AS
SELECT
...
FROM `{{ project_id_tgt }}.{{ dataset_reporting_tgt }}.AdsDailyStatsByHierAndCountry` ads
FULL JOIN `{{ project_id_tgt }}.{{ dataset_reporting_tgt }}.DailySalesByHierAndCountry` sales
ON
